...
namespace Jouska.AutoFixture.Extensions.Http.SzalayMock;
...
public static class AutoFixtureExtensions
{
    extension(IFixture fixture)
    {
        ...
        public IFixture WithHttpClientFactory(string httpClientName, MockHttpMessageHandler mockHttpMessageHandler)
        {
        ...
        /// <param name="httpClientName">the name of the httpclient</param>
        /// <returns>An updated fixture instance configured with an IHttpClientFactory test implementation.</returns>
        public IFixture WithHttpClientFactory(params (string httpClientName, MockHttpMessageHandler mockHttpMessageHandler)[] httpClients)
        {
        ...
        /// <returns>An updated fixture instance configured with an IHttpClientFactory test implementation.</returns>
        public IFixture WithHttpClientFactory(Dictionary<string, MockHttpMessageHandler> httpMessageHandlers)
        {
        ...
        public IFixture WithHttpClient(MockHttpMessageHandler mockHttpMessageHandler)
        {
