...
public static class AutoFixtureExtensions
{
    extension(IFixture fixture)
    {
        ...
        public IFixture WithHttpClientFactory(string httpClientName, DelegatingHandler delegatingHandler)
        {
        ...
        /// <returns>An updated fixture instance configured with an IHttpClientFactory test implementation.</returns>
        public IFixture WithHttpClientFactory(params (string httpClientName, DelegatingHandler delegatingHandler)[] httpClients)
        {
        ...
        public IFixture WithHttpClient(DelegatingHandler delegatingHandler)
        {
        ...
        /// <returns>An updated fixture instance configured with an HttpClient.</returns>
        public IFixture WithHttpClient(params (string route, HttpStatusCode responseStatus)[] routesAndResponses)
        {
