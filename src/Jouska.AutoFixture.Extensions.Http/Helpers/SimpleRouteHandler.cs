...
namespace Jouska.AutoFixture.Extensions.Http.Helpers;
...
public class SimpleRouteHandler : DelegatingHandler
{
    ...
    public SimpleRouteHandler WithRoute(string path, object responseBody)
    {
        ...
        {
#if NETSTANDARD
            Content = new StringContent(System.Text.Json.JsonSerializer.Serialize(responseBody), System.Text.Encoding.UTF8, "application/json")
#else
            Content = System.Net.Http.Json.JsonContent.Create(responseBody)
#endif
        });
        return this;
    }
