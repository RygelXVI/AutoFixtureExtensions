...
public static class AutoFixtureExtensions
{
    extension(IFixture fixture)
    {
        ...
        public IFixture Inject<TInterface, TImplementation>(TImplementation implementation) where TImplementation : class, TInterface
        {
        ...
        /// <param name="fixture">IFixture instance being configured</param>
        /// <returns>IFixture</returns>
        public IFixture WithTypeRelay<TInterface, TImplementation>()
        {
            fixture.Customizations.Add(new TypeRelay(typeof(TInterface), typeof(TImplementation)));
            return fixture;
        }
        ...
        /// <returns>IFixture</returns>
        public IFixture WithNamedParameterValue<TParam>(string parameterName, TParam value)
        {
