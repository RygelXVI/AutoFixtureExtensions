...
public static class AutoFixtureExtensions
{
    extension(IFixture fixture)
    {
        ...
        public IFixture WithSerilogProvider()
        {
        ...
        /// <returns>IFixture</returns>
        public IFixture WithSerilogProvider(LoggerConfiguration loggerConfiguration)
        {
        ...
        public IFixture WithSerilogProvider(Action<LoggerConfiguration> loggerConfiguration)
        {
            var configuration = new LoggerConfiguration();
            loggerConfiguration(configuration);
            return WithSerilogProvider(fixture, configuration);
        }
        ...
        /// <returns>IFixture</returns>
        public IFixture WithSerilogProvider(Logger logger)
        {
        ...
        /// <returns>IFixture</returns>
        public IFixture WithSerilog(LogEventLevel minimumLogEventLevel)
        {
            fixture.Register(() => new LoggerConfiguration()
                .Enrich.FromLogContext()
        ...
        /// <returns>IFixture</returns>
        public IFixture WithSerilog(LoggerConfiguration loggerConfiguration)
        {
        ...
        public IFixture WithSerilog(Action<LoggerConfiguration> loggerConfiguration)
        {
            var configuration = new LoggerConfiguration();
            loggerConfiguration(configuration);
            return WithSerilog(fixture, configuration);
        }
        ...
        /// <returns>IFixture</returns>
        public IFixture WithSerilog(Logger logger)
        {
            fixture.Register(() => logger);
            fixture.Customizations.Add(CreateSerilogTypeRelay());
